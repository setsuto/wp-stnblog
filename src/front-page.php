...
<div class="l-content__width">
  ...
  <!-- <section class="u-pt40">
    ...
    <article class="p-hero u-pt50" id="qiita-posts">
      <div v-for="post in limitCount" class="p-hero__content">
        ...
        <div class="p-hero__body">
          <div class="p-hero__title">
            <a v-bind:href="post['url']" target="_blank">
              <h2 class="p-hero__title">{{ post['title'] }}</h2>
            </a>
          </div>
        </div>
        <time class="p-hero__time">{{ post.created_at | moment }}</time>
      </div>
    </article>
  </section> -->
  ...
  <main class="content u-pt80">
    <article class="content__article">
      <section class="news">
        ...
        <div class="p-hero__container u-pt50" id="pickup">
